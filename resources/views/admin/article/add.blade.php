            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" action="{{url('/admin/article')}}" method="post" id="commentForm" enctype="multipart/form-data">
							...
							<div class="form-group">
							    ...
							    <div class="col-sm-8">
							        <input type="write" name="write" class="form-control" name="url">
							    </div>
							</div>
